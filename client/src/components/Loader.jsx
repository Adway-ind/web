...
export default function Loader() {
  ...
  return (
    <>
      ...
      {visible && (
        <div
          className={`fixed inset-0 z-[99999] flex flex-col items-center justify-center bg-black transition-opacity duration-700 ${fadeOut ? "opacity-0 pointer-events-none" : "opacity-100"
            }`}
        >
          {/* Brand Name */}
      ...
      <div
        className={`fixed inset-0 z-[99998] bg-black pointer-events-none transition-opacity duration-500 ${transitioning ? "opacity-100" : "opacity-0"
          }`}
      />
    </>
  );
