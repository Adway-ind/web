...
export default function Blog() {
  ...
  const breadcrumbSchema = createBreadcrumbSchema([
    ...
    {
      name: "Blog",
      url: "https://adwaycreations.com/blog",
    },
    {
      name: blog.title,
      url: `https://adwaycreations.com/blog/${blog.slug}`,
    },
  ]);
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Explore the Adway Creations blog for insights, ideas and trends in branding, graphic design, packaging design, web development, digital marketing and social media marketing."
        />
