...
const pageSchema = createWebPageSchema({
  name: "About Adway Creations",
  description:
    "Learn about Adway Creations, a creative branding and digital marketing agency.",
  url: "https://adwaycreations.com/about",
});
  ...
  return (
    <>
      <Helmet>
        ...
        <link
          rel="canonical"
          href="https://adwaycreations.com/about"
        />
        ...
        <meta
          property="og:title"
          content="About Adway Creations | Creative Branding Agency in Kerala"
        />

        <meta
          property="og:description"
          content="Discover the story, vision and creative approach behind Adway Creations."
        />

        <meta
          property="og:url"
          content="https://adwaycreations.com/about"
        />
