...
export default function Clients() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Our Clients | Brands We Work With | Adway Creations
        </title>

        <meta
          name="description"
          content="Explore the brands and businesses that trust Adway Creations for branding, graphic design, packaging design, web development and digital marketing."
        />
        ...
        <link
          rel="canonical"
          href="https://adwaycreations.com/clients"
        />
        ...
        <meta
          property="og:title"
          content="Our Clients | Brands We Work With | Adway Creations"
        />

        <meta
          property="og:description"
          content="Discover the brands and businesses that work with Adway Creations for creative branding, design, web development and digital marketing."
        />

        <meta
          property="og:url"
          content="https://adwaycreations.com/clients"
        />
        ...
        <meta
          ...
          content="Explore the brands and businesses that trust Adway Creations for creative and digital solutions."
        />
