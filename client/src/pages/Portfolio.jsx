...
export default function Portfolio() {
  ...
  return (
    <>
      <Helmet>
        <title>Portfolio | Branding, Packaging & Web Design | Adway Creations</title>

        <meta
          name="description"
          content="Explore Adway Creations' portfolio featuring branding, logo design, packaging design, web development, UI/UX design and digital marketing projects across multiple industries."
        />

        <meta name="robots" content="index, follow" />

        <link rel="canonical" href="https://adwaycreations.com/portfolio" />

        {/* Open Graph */}
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="Adway Creations" />
        <meta
          property="og:title"
          content="Portfolio | Branding, Packaging & Web Design | Adway Creations"
        />
        <meta
          property="og:description"
          content="Discover premium branding, packaging, website and digital marketing projects created by Adway Creations."
        />
        <meta property="og:url" content="https://adwaycreations.com/portfolio" />
        <meta property="og:image" content="https://adwaycreations.com/og-image.jpg" />
