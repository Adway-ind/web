...
const categories = ['All', 'Brand Strategy', 'Visual Identity', 'Digital Design', 'Motion Graphics']
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filtered.map((project) => (
              <Link
                ...
                key={project.slug}
                className="group relative rounded-2xl overflow-hidden bg-white border border-gray-100 hover:border-accent/20 hover:shadow-xl transition-all duration-500"
              >
                {/* Project Image */}
                <div className="aspect-[4/3] relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <div className="px-5 py-2.5 bg-white rounded-full text-accent text-sm font-semibold flex items-center gap-2 shadow-lg">
                      View Project
                ...
                <div className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mt-1 group-hover:text-accent transition-colors">
                    {project.title}
                  </h3>
