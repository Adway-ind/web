...
export default function Career() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Careers at Adway Creations | Join Our Creative Team
        </title>

        <meta
          name="description"
          content="Explore career opportunities at Adway Creations. Join our creative team working across branding, graphic design, digital marketing, web development, UI/UX and creative technology."
        />
        ...
        <link
          rel="canonical"
          href="https://adwaycreations.com/career"
        />
        ...
        <meta
          property="og:title"
          content="Careers at Adway Creations | Join Our Creative Team"
        />

        <meta
          property="og:description"
          content="Join Adway Creations and build your career in branding, design, digital marketing, web development and creative technology."
        />

        <meta
          property="og:url"
          content="https://adwaycreations.com/career"
        />
        ...
        <meta
          ...
          content="Explore career opportunities and join the creative team at Adway Creations."
        />
