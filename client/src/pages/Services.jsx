...
const serviceSchema = createServiceSchema({
  ...
  description:
    "Professional branding, visual identity, web development, motion graphics, brand growth and digital marketing services.",
  url: "https://adwaycreations.com/services",
});
...
export default function Services() {
  return (
    <>
      <Helmet>
        <title>
          Branding & Digital Marketing Services | Adway Creations
        </title>

        <meta
          name="description"
          content="Explore Adway Creations services including brand strategy, logo design, visual identity, packaging design, graphic design, UI/UX design, web development, motion graphics and digital marketing."
        />
        ...
        <link
          rel="canonical"
          href="https://adwaycreations.com/services"
        />
        ...
        <meta
          property="og:title"
          content="Branding & Digital Marketing Services | Adway Creations"
        />

        <meta
          property="og:description"
          content="From brand strategy and visual identity to packaging, web development and digital marketing, explore the creative services offered by Adway Creations."
        />

        <meta
          property="og:url"
          content="https://adwaycreations.com/services"
        />
        ...
        <meta
          ...
          content="Branding, packaging design, web development, UI/UX and digital marketing services from Adway Creations."
        />
