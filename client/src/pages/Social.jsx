...
export default function Social() {
  return (
    <>
      <Helmet>
        <title>Social Media Marketing & Creative Content | Adway Creations</title>

        <meta
          name="description"
          content="Explore Adway Creations' social media marketing, creative campaigns, visual content, and digital brand experiences designed to grow businesses online."
        />
        ...
        <link
          rel="canonical"
          href="https://adwaycreations.com/social"
        />
        ...
        <meta
          property="og:url"
          content="https://adwaycreations.com/social"
        />
        <meta
          property="og:title"
          content="Social Media Marketing & Creative Content | Adway Creations"
        />
        <meta
          property="og:description"
          content="Creative social media marketing, campaigns, and digital content by Adway Creations."
        />
        <meta
          property="og:image"
