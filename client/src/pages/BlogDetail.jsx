  ...
  return (
    <>
      <Helmet>
        <title>
          {blog?.title
            ? `${blog.title} | Adway Creations`
            : "Blog | Adway Creations"}
        </title>
        ...
        <meta
          ...
          content={
            blog?.excerpt ||
            blog?.description ||
            "Read the latest insights on branding, design, digital marketing, web development, and creative strategy from Adway Creations."
          }
        />
        ...
        <link
          rel="canonical"
          href={`https://adwaycreations.com/blog/${blog?.slug || slug}`}
        />
        ...
        <meta
          property="og:url"
          content={`https://adwaycreations.com/blog/${blog?.slug || slug}`}
        />

        <meta
          property="og:title"
          content={blog?.title || "Adway Creations Blog"}
        />
          ...
          content={
            blog?.image
              ? blog.image.startsWith("http")
                ? blog.image
                : `https://adwaycreations.com${blog.image}`
              : "https://adwaycreations.com/og-image.jpg"
          }
        />
      ...
      <section className="relative bg-black pt-24 pb-12 overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-6 lg:px-8">
          ...
          {/* Title */}
          <h2 className="text-white text-4xl sm:text-5xl font-bold leading-[1.1] tracking-[-0.02em] mb-6">
            {blog.title}
          </h2>
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          mainEntityOfPage: {
            "@type": "WebPage",
            "@id": `https://adwaycreations.com/blog/${blog?.slug || slug}`,
          },
        })}
      </script>
    </>
